    ...
    for( NSDictionary* arr in trainsArr){
        ...
        for( NSDictionary* infoDict in weekDaysData){
            ...
            for(int j=0; j<trainCount; j++){
                ...
                for(int i=0; i<dataArr.count; i+=trainCount){
                    int index= (i/trainCount);
...
-(void)parseStationsFromArray:(NSArray*)d dataTable:(NSArray*)dataTableArr stations:(NSArray*)stations trains:(NSMutableArray*)trains days:(NSArray*)days{
    int index= 0;
    SMTime* time= [SMTime new];
...
//
//        "stations":["København H","Vesterport","Nørreport","Østerport","Jægersborg","Jægersborg","Nørgaardsvej","Lyngby Lokal","Fuglevad","Brede","Ørholm","Ravnholm"],
//        
//        "departure": {
//            "weekdays" : [
//                          {"start-time":5.14, "end-time":0.34, "data":[14, 34, 54, 16, 36, 56, 17, 37, 57, 19, 39, 59, 22, 42, 2, 24, 44, 4, 25, 45, 5, 27, 47, 7, 29, 49, 9, 43, 3, 23, 45, 5, 25, 47, 7, 27, 50, 10, 30]},
//                          {"start-time":1.14, "end-time":1.14, "data":[14, 16, 17, 19, 22, 24, 25, 27, 29, 43, 45, 47, 50]},
//                          {"start-time":6.44, "end-time":9.04, "data":[4, 24, 44, 6, 26, 46, 7, 27, 47, 9, 29, 49, 12, 32, 52, 14, 34, 54, -1, -1, -1, 17, 37, 57, 19, 39, 59, 33, 53, 13, 35, 55, 15, 37, 57, 17, 40, 0, 20]},
//                          {"start-time":15.44, "end-time":17.04, "data":[4, 24, 44, 6, 26, 46, 7, 27, 47, 9, 29, 49, 12, 32, 52, 14, 34, 54, -1, -1, -1, 17, 37, 57, 19, 39, 59, 33, 53, 13, 35, 55, 15, 37, 57, 17, 40, 0, 20]}
//                          ],
//            
//            "weekend" : {
//                "saturday" : [
...
//                               
//                               [14, 34, 54, 16, 36, 56, 17, 37, 57, 19, 39, 59, 22, 42, 2, 24, 44, 4, 25, 45, 5, 27, 47, 7, 29, 49, 9, 43, 3, 23, 45, 5, 25, 47, 7, 27],
//                               
